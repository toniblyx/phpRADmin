...
//
// $Id: common_functions.php,v 1.1 2005/06/09 14:31:11 julio234 Exp $
...
function create_bargraph ($percent, $a, $b, $type = "") {
    if ($percent == 0) { 
        return '<img height="' . BAR_HEIGHT . '" src="sysinfo/templates/' . TEMPLATE_SET . '/images/bar_left.gif" alt="">'
              . '<img src="sysinfo/templates/' . TEMPLATE_SET . '/images/bar_middle.gif" height="' . BAR_HEIGHT . '" width="1" alt="">'
              . '<img src="sysinfo/templates/' . TEMPLATE_SET . '/images/bar_right.gif" height="' . BAR_HEIGHT . '" alt="">';
    } else if (($percent < 90) || ($type == "iso9660")) {
        return '<img height="' . BAR_HEIGHT . '" src="sysinfo/templates/' . TEMPLATE_SET . '/images/bar_left.gif" alt="">'
              . '<img src="sysinfo/templates/' . TEMPLATE_SET . '/images/bar_middle.gif" height="' . BAR_HEIGHT . '" width="' . ($a * $b) . '" alt="">'
              . '<img height="' . BAR_HEIGHT . '" src="templates/' . TEMPLATE_SET . '/images/bar_right.gif" alt="">';
    } else {
        return '<img height="' . BAR_HEIGHT . '" src="sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_left.gif" alt="">'
             . '<img src="sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_middle.gif" height="' . BAR_HEIGHT . '" width="' . ($a * $b) . '" alt="">'
             . '<img height="' . BAR_HEIGHT . '" src="sysinfo/templates/' . TEMPLATE_SET . '/images/redbar_right.gif" alt="">';
    }
}
