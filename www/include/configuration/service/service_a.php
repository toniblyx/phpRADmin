...
<tr>
	<td width="50%">HostGroup name :<font color='red'>*</font></td>
	<td class="text10b">
...
<tr>
	...
	<? } ?>
	<input ONMOUSEOVER="montre_legende('Warning', '');" ONMOUSEOUT="cache_legende();" name="sv[service_notification_options_w]" type="checkbox" id="templateNotificationOptions" value="w" <? if (isset($option_not["w"]) && strcmp($option_not["w"], "")) print "Checked";?> <? if ($nos) echo "disabled";?>> w -
	<input ONMOUSEOVER="montre_legende('Unknown', '');" ONMOUSEOUT="cache_legende();" name="sv[service_notification_options_u]" type="checkbox" id="templateNotificationOptions" value="u" <? if (isset($option_not["u"]) && strcmp($option_not["u"], "")) print "Checked";?> <? if ($nos) echo "disabled";?>> u -
	<input ONMOUSEOVER="montre_legende('Critical', '');" ONMOUSEOUT="cache_legende();" name="sv[service_notification_options_c]" type="checkbox" id="templateNotificationOptions" value="c" <? if (isset($option_not["c"]) && strcmp($option_not["c"], "")) print "Checked";?> <? if ($nos) echo "disabled";?>> c
	<input ONMOUSEOVER="montre_legende('Recovery', '');" ONMOUSEOUT="cache_legende();" name="sv[service_notification_options_r]" type="checkbox" id="templateNotificationOptions" value="r" <? if (isset($option_not["r"]) && strcmp($option_not["r"], "")) print "Checked";?> <? if ($nos) echo "disabled";?>> r
</tr>
<tr>
...
<tr>
	...
	<? } ?>
	<input ONMOUSEOVER="montre_legende('Ok', '');" ONMOUSEOUT="cache_legende();" name="sv[service_stalking_options_o]" type="checkbox" id="templateStalkingOptions" value="o" <? if (isset($option_sta["o"]) && strcmp($option_sta["o"], "")) print "Checked";?> <? if ($sos) echo "disabled";?>> o -
	<input ONMOUSEOVER="montre_legende('Warning', '');" ONMOUSEOUT="cache_legende();" name="sv[service_stalking_options_w]" type="checkbox" id="templateStalkingOptions" value="w" <? if (isset($option_sta["w"]) && strcmp($option_sta["w"], "")) print "Checked";?> <? if ($sos) echo "disabled";?>> w -
	<input ONMOUSEOVER="montre_legende('Unknown', '');" ONMOUSEOUT="cache_legende();" name="sv[service_stalking_options_u]" type="checkbox" id="templateStalkingOptions" value="u" <? if (isset($option_sta["u"]) && strcmp($option_sta["u"], "")) print "Checked";?> <? if ($sos) echo "disabled";?>> u
	<input ONMOUSEOVER="montre_legende('Critical', '');" ONMOUSEOUT="cache_legende();" name="sv[service_stalking_options_c]" type="checkbox" id="templateStalkingOptions" value="c" <? if (isset($option_sta["c"]) && strcmp($option_sta["c"], "")) print "Checked";?> <? if ($sos) echo "disabled";?>> c
	</td>
</tr>
<tr>
	<td valign="top"><? echo $lang['status']; ?> :</td>
	<td class="text10b">
		<input type="radio" name="sv[service_activate]" value="1" checked><? echo $lang['enable']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="sv[service_activate]]" value="0"><? echo $lang['disable']; ?>
	</td>
</tr>
<tr>
