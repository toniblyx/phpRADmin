...
<table   cellpadding="0" cellspacing="3" width="350" align='center'>
	<tr>
		...
		<td class="text10b"><input type="text" name="hg[hg_name]"></td>
	</tr>
	<tr>
		<td style="white-space: nowrap;"><? echo $lang['alias']; ?><font color='red'>*</font></td>
		<td class="text10b"><input type="text" name="hg[hg_alias]"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="text10b">
			<input type="radio" name="hg[hg_activate]" value="1" checked><? echo $lang['enable']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="hg[hg_activate]" value="0"><? echo $lang['disable']; ?>
		</td>
	</tr>
	<tr>
		<td valign="top" style="white-space: nowrap;">Comment :</td>
		<td class="text10b">
			<textarea name="hg[hg_comment]" cols="25" rows="4"></textarea>
		</td>
	</tr>
	<tr>
		<td align="left">
		...
		<td align="center">
			<input type="submit" name="AddHG" value="<? echo $lang['save']; ?>" onClick="selectAll(this.form.selectHost);selectAll(this.form.selectCG);">
		</td>
	</tr>
</table>
</form>