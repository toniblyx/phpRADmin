...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left">
					<form action="phpradmin.php?p=207" method="POST" enctype="multipart/form-data">
						<? if (isset($msg))
						...
						<tr>
							<td valign="top" align="center" class="tabTableForTab">
								...
								if (isset($table_rep)){
									...
									{
										echo "<TR>";
										echo "	<TD BGCOLOR='#EBEEF3' bordercolor='#EBEEF3' ALIGN='left'>&nbsp;&nbsp;&nbsp;<a href='phpradmin.php?p=207&a=w&n=$rep' class='text10'>$rep</a></TD>";
								...
								if (isset($table_file)){
									...
									{
										echo "<TR>";
										echo "	<TD BGCOLOR='#EBEEF3' bordercolor='#EBEEF3' ALIGN='left'>&nbsp;&nbsp;&nbsp;<a href='phpradmin.php?p=207&a=w&n=$file' class='text10'>$file</a></TD>";
										echo "	<TD BGCOLOR='#EBEEF3' bordercolor='#EBEEF3' ALIGN='right' COLSPAN='1'><font class='link'>";
										printf("%u", filesize($oreon->optGen->get_plugins_path() . "$file") / 1000);
										echo " ko</font></TD>";
										echo "	<TD BGCOLOR='#EBEEF3' bordercolor='#EBEEF3' ALIGN='center' COLSPAN='1'><a href='phpradmin.php?p=207&a=delete&file=".$file."'><img src='./img/listDel.gif' border=0  onclick=\"return confirm('".$lang['plugins2']."')\"></a></TD>";
										echo "</TR>";
										unset($file);
									}
								}
