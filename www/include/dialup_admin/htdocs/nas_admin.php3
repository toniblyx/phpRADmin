...
if ($clear_fields == 1)
	...
	echo <<<EOM
<option value="change_nas">Change NAS/Client Info
<option value="del_nas">Delete Selected NAS/Client
<option value="check_nas">Check NAS/Client validity
EOM;
?>
</select>
<input type=submit class=button value="Perform Action" OnClick="this.form.do_it.value=1">
<br><br>
<input type=submit class=button value="Add NAS/Client" OnClick="this.form.clear_fields.value=1">
</form>
</td></tr>
</table>
</tr>
