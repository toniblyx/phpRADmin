...
<tr valign=top>
<td width=75%>&nbsp;</td>
<td bgcolor="888888" width=25% align=right>
	<table border=0 width="200" cellpadding=2 cellspacing=0>
	<tr bgcolor="#aaaaaa" align=center valign=top><th>
...
?>
<tr>
<td align=right colspan=<?php print $colspan ?> bgcolor="#e6e6e6">
Add Attribute
</td>
<td>
...
<a href="help/badusers_help.html" target=bu_help onclick=window.open("help/badusers_help.html","bu_help","width=600,height=210,toolbar=no,scrollbars=no,resizable=yes") title="BADUSERS Help Page"><font color="blue">Badusers Help</font></a>
EOM;
}
?>
</form>
