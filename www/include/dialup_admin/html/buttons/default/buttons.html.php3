...
function myout(a) {
	eval ( "document.all.menu" + a + ".style.backgroundColor='#e6e6e6';" );
...
?>
<tr bgcolor="888888" valign=top><td>
...
<tr bgcolor="#e6e6e6" valign=top><td>
...
<tr bgcolor="#e6e6e6" align=right valign=bottom><td><img vspace=0 hspace=0 src="images/bg.gif"></td></tr>
</table>
</td></tr>
</table>
</form>
