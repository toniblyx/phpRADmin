									...
									foreach ($hosts as $h){
										if ($oreon->is_accessible($h->get_id())){
											...
											<div style="padding: 2px; white-space: nowrap" align="left">
												<li>
													<a href="phpradmin.php?p=501&h=<? echo $h->get_id(); ?>" class="text10" style="white-space: nowrap;">
													<? echo $h->get_name(); ?>
													</a>
												</li>
											</div>
									...
									<tr>
										<td valign="top" class='tabTableForTab' style="border-bottom:0px;padding-left:20px;">
											<div style="padding-left: 20px;padding:10px;float:left;width:300px;">
												...
												<ul>
													<li type="square"><a href='./phpradmin.php?p=102&h=<? print $_GET["h"]; ?>&o=w' class='text10'><? echo $lang["lr_configure_host"]; ?></a></li>
													<li type="square"><a href='./phpradmin.php?p=303&o=s&host_id=<? print $_GET["h"]; ?>' class='text10'><? echo $lang["lr_view_services"]; ?></a></li>
													<li type="square"><a href='./phpradmin.php?p=314&h=<? print $_GET["h"]; ?>' class='text10'><? echo $lang["lr_details_host"]; ?></a></li>
												</ul>
											</div>
											<div>
										<?
										if (isset($_GET["h"]	) && isset($Logs->log_h[$_GET["h"]])){
											...
											$str = "<a href='./phpradmin.php?p=303&o=s&host_id=".$oreon->hosts[$_GET["h"]]->get_id()."'><img src='./include/reports/draw_graph_host.php?sn=$sn&coord_x=$x&coord_y=$y&fontcolor=";
